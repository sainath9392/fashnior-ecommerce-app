      ...
      <div className="flex flex-col gap-3 p-3">
        <div>
          ...
          <p className="text-sm">
            ...
            velit et officiis, ducimus tempora, ad aut minus cumque unde, harum
            quasi optio illo quas voluptas nihil quae repellendus repellat
            eaque.
          </p>
          <p className="text-sm">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Velit,
            accusantium dolorum voluptatum maiores ipsum distinctio.
          </p>
        </div>
        <div>
          <h5 className="h5">Benefit</h5>
          <div className="list-disc pl-1 text-sm text-gray-500 flex flex-col gap-1">
            <li>
