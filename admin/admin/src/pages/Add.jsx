      ...
      >
        ...
        <div className="w-full">
          ...
          <textarea
            ...
            rows={5}
            placeholder="Write here..."
            className="px-3 py-1.5 ring-1 ring-slate-900/5 rounded bg-white mt-1 w-full max-w-lg"
          />
        </div>
        {/* Categories */}
        <div>
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex flex-row gap-4">
              <div className="">
                ...
                <select
                  ...
                  value={category}
                  className="max-w-20 px-3 py-2 text-gray-500 ring-1 ring-slate-900/5 rounded bg-white"
                >
              ...
              <div>
                ...
                <select
                  ...
                  value={subCategory}
                  className="max-w-32 px-3 py-2 text-gray-500 ring-1 ring-slate-900/5 rounded bg-white"
                >
            ...
            <div>
              ...
              <input
                ...
                type="number"
                placeholder="10"
                className="px-3 py-2 ring-1 ring-slate-900/5 text-gray-500 bg-white max-w-24 rounded"
              />
            </div>
          </div>
        </div>
