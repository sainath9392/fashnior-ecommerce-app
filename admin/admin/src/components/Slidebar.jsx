...
const Slidebar = ({setToken}) => {
  return (
    <div className="max-sm:flexCenter max-xs:pb-3 rounded bg-white pb-3 sm:w-1/5 sm:max-h-screen sm:sticky sm:top-0 sm:left-0">
      <div className="flex flex-col gap-y-6 max-sm:items-center sm:flex-col pt-4 sm:pt-14">
        {/* logo */}
        <Link className="bold-22 xl:bold-32 sm:pl-2 lg:pl-12" to={"/"}>
